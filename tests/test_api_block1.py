...
def test_session_save_load_and_list(client):
    ...
    assert saved_path.parent.name == "demo_session"
    assert (saved_path.parent / "templates").exists()
    assert (saved_path.parent / "generated").exists()
    assert (saved_path.parent / "attachments" / "materials").exists()
    assert (saved_path.parent / "attachments" / "appendices").exists()
